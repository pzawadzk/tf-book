...
from model import _input_fn, get_model
...
def main(args):
    ...
    train_dataset = _input_fn('train', args.batch_size) #process_input(args.epochs, args.batch_size, args.train, 'train', args.data_config)
    eval_dataset =_input_fn('eval', args.batch_size) # process_input(args.epochs, args.batch_size, args.eval, 'eval', args.data_config)
    validation_dataset = _input_fn('eval', args.batch_size) #process_input(args.epochs, args.batch_size, args.validation, 'validation', args.data_config)
    ...
    #Deal with this
    model = get_model(args.n_neurons, args.n_hidden)
#     callbacks = []
...
#         callbacks.append(CustomTensorBoardCallback(log_dir=tensorboard_dir))
    ...
    history = model.fit(train_dataset,
              ...
              validation_steps=(num_examples_per_epoch('eval') // args.batch_size) // size,
                        #, callbacks=callbacks
                       )
